...
- [public-alpha/README.md](public-alpha/README.md) — 공개용 alpha 패키지 개요
- [public-alpha/STATUS.md](public-alpha/STATUS.md) — 검증된 것 / 미검증인 것
- [public-alpha/skills/](public-alpha/skills/) — core/auth/filesystem/orm draft
