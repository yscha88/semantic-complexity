...
| 🧀 Cheese SKILL B vs D | **파일럿** — **5 레포**, 2 모델(sonnet/opus), 1회 | gpt-5.4 추가, 3회 반복, TS/Go 확장 |
| 🥓 Ham SKILL B vs D | **파일럿** — **5 레포**, 2 모델(sonnet/opus), 1회 | gpt-5.4 추가, 3회 반복, TS/Go 확장 |
...
| **🧀 Cheese B vs D** | **🧀** | **marshmallow, toml, h2, arq + icloud** | **5** | **D>B 4/5 (80%)** — CC 등급 정확도 우위, 추가 발견 3-4개/레포 |
| **🥓 Ham B vs D** | **🥓** | **saq, arq, procrastinate, marshmallow + icloud** | **5** | **D>B 5/5 (100%)** — critical path +1-3개, 추가 발견 3-4개/레포 |
...
| 3축을 유지해야 하는가? | 현재 실험(EXP-02, EXP-03, Cheese/Ham B vs D)은 🍞🧀🥓 3축 모두 SKILL 효과 확인. Cheese 4/5, Ham 5/5. 3축의 **조합**이 최적인지는 미검증 |
